...
const data = [7000, 9000, 6000, 10000, 4000, 8000, 5000, 9000, 3000, 6000];
const data2 = [4200, 5200, 6100, 7000, 7800, 8600, 9300, 9800, 10200, 11000];
const sum = (arr: number[]) =>
    arr.reduce((total, v) => total + v, 0)
    ...
    return (
        ...
        >
            ...
            >
                <View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={{ fontWeight: "700", lineHeight: 22, fontSize: 12 }}> ${todayTotal.toLocaleString()}</Text>
                        <Text style={{ color: changeColor, fontWeight: "500", lineHeight: 20, fontSize: 14 }}>  {changeArrow} {Math.abs(percent).toFixed(2)}%</Text>
                    </View>
                </View>
            ...
            <Svg width={WIDTH} height={HEIGHT}>
                ...
                {/* Y labels */}
                <SvgText x={4} y={HEIGHT - PADDING} fontSize="10">
                    $0
                </SvgText>
                <SvgText x={4} y={PADDING + 4} fontSize="10">
                    $10k
                </SvgText>
